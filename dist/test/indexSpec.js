...
var imagesModel_1 = __importDefault(require("./../models/imagesModel"));
...
describe("test image processing app ", function () {
    ...
    describe("test image router ", function () {
        ...
        it("test without sending a request to server.", function () { return __awaiter(void 0, void 0, void 0, function () {
            var image, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        image = new imagesModel_1.default("encenadaport", 300, 600);
                        _a = expect;
                        return [4 /*yield*/, image.getImagePath()];
                    case 1:
                        _a.apply(void 0, [(_b.sent()).split("\\").slice(-3).join("\\")]).toEqual("images\\thumbnail\\encenadaport_300_600.jpg");
                        return [2 /*return*/];
                }
            });
        }); });
